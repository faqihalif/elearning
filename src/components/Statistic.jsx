        ...
        <div className="container px-8 pt-12 mx-auto">
            ...
            <div className="flex justify-between space-x-16">
                ...
                <div className="flex items-center w-full space-x-8">
                    ...
                    <div>
                        <div className="mb-2">
                            <p className="text-4xl font-extrabold text-gray-800">480,000+</p>
                        </div>
                        <div>
                            <p className="text-xl text-gray-600">Enrolled Student</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center w-full space-x-8">
                    ...
                    <div>
                        <div className="mb-2">
                            <p className="text-4xl font-extrabold text-gray-800">4,000+</p>
                        </div>
                        <div>
                            <p className="text-xl text-gray-600">Expert Instructor</p>
                        </div>
                    </div>
                </div>
            </div>
